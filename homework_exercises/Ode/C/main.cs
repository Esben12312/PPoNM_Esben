...
class main {
	public static void Main() {
		WriteLine();
		WriteLine("Three body diagram using previously made ode45");
		WriteLine();
		WriteLine("The solution is illustrated in Three_Body.png");
		WriteLine("Initial values found at http://www.artcompsci.org/msa/web/vol_1/v1_web/node45.html");
		WriteLine();
		WriteLine();
		...
		using(var outfile = new System.IO.StreamWriter("Three_Body.txt")){
